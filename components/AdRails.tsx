...
//
// This component ships near-IDENTICALLY in the OWdle repo (event + prop
// names exactly shared — DailyDles dashboards span both sites; `site` /
...
const TOP_OFFSET_PX = 88; // clears the sticky site header
...
// Rails measure only the pages that would carry ads: home + built public
// modes. Everything else (labeler, share shells, dev-only archive) is out
// of scope — no probes, no events, so the denominators stay clean.
