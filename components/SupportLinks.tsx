...
// engagement section. Links live in lib/support.ts so they can be
// tweaked without touching the component.
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <p className="mt-2 text-sm text-ink-soft">
        Deadlockle is a solo side project — no ads, no signup, no tracking.
        If you want to keep new modes (and new games) coming:
      </p>
