      ...
      <div className="mt-7 flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="group relative shrink-0">
            ...
            <div
              role="tooltip"
              className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-3 w-48 origin-bottom-left scale-90 rounded-2xl border border-line bg-ink px-3 py-2 text-center font-sans text-xs leading-snug text-canvas opacity-0 shadow-[0_6px_16px_-4px_rgba(0,0,0,0.45)] transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-100 group-hover:opacity-100 group-focus-within:scale-100 group-focus-within:opacity-100"
            >
