...
// avoid assumptions/new deps) while producing identical output. Mirrors
// OWdle's components/GoogleAnalytics.tsx — keep the two in lockstep.
//
...
//
// Production-only: gtag never loads under `next dev`, keeping dev/localhost
// traffic out of the GA property that Monumetric is about to review.
