...
// the text (classic emoji grid, daily summary, …) and this owns the
...
// /r/[code] unfurl card. Adapted from OWdle's TextShareBlock.
type Props = {
  text: string;
    ...
    <div className="w-full">
      ...
      <div className="mt-3 flex flex-wrap items-center justify-center gap-3">
        <button
          type="button"
          onClick={copy}
          className="inline-flex items-center gap-2 rounded-(--radius-pill) border border-info/40 bg-info/15 px-5 py-3 text-info transition-all hover:border-info hover:bg-info/25 active:scale-[0.98]"
        >
