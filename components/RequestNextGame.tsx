    ...
    <div ref={wrapRef} className="flex h-full flex-col">
      {submitted ? (
          ...
          <>
            ...
            <h3 className="mt-1.5 font-display text-lg text-ink sm:text-xl">
            ...
            <div className="mt-3.5 flex items-center gap-3">
              <button
                ...
                className={clsx(
                  "inline-flex items-center gap-2 rounded-full px-5 py-2 font-sans text-sm font-semibold transition-all duration-150",
                  selected && !voted.includes(selected.id)
