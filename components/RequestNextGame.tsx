...
// should get the Deadlockle treatment next. Search is proxied through
...
const STORAGE_KEY = "deadlockle:requested-games";
...
const DEV_STUB_LEADERBOARD: LeaderEntry[] = [
  {
    game_id: "dev-stub-1",
    game_name: "Minecraft",
    game_image: "https://picsum.photos/seed/deadlockle-stub-mc/640/280",
    game_released: "2011-11-18",
  },
  {
    game_id: "dev-stub-2",
    game_name: "Baldur's Gate III",
    game_image: "https://picsum.photos/seed/deadlockle-stub-bg3/520/220",
    game_released: "2023-08-03",
  },
  {
    game_id: "dev-stub-3",
    game_name: "Honkai: Star Rail",
    game_image: "https://picsum.photos/seed/deadlockle-stub-hsr/520/220",
    game_released: "2023-04-26",
  },
  {
    game_id: "dev-stub-4",
    game_name: "Cookie Clicker",
    game_image: "https://picsum.photos/seed/deadlockle-stub-cc/520/220",
    game_released: "2013-08-08",
  },
  {
    game_id: "dev-stub-5",
    game_name: "Genshin Impact",
    game_image: "https://picsum.photos/seed/deadlockle-stub-gi/520/220",
    ...
    <div ref={wrapRef} className="flex h-full flex-col">
      {submitted ? (
          ...
          <>
            ...
            <h3 className="mt-1.5 font-display text-lg font-bold text-ink sm:text-xl">
            ...
            <div className="relative mt-3">
              ...
              >
                ...
                <button
                  ...
                  className={clsx(
                    "my-1 mr-1 inline-flex shrink-0 self-center items-center rounded-full px-3 py-1 font-display text-xs font-bold transition-colors duration-150",
                    selected && !voted.includes(selected.id)
