...
// slotId no longer arms a unit by itself (that shipped an empty white mobile
// anchor / rails during the review window — Google reserves the box but has
// nothing approved to fill, and the collapse-on-unfilled net doesn't fire
// reliably pre-approval). Units go live only when Google actually will serve.
// See ADSENSE_APPROVED.
//
...
//
// Ships near-identically in the OWdle repo (the canonical source) — keep unit
// roles/sizes in lockstep; only the ids differ per site.
