    ...
    strategy: [
      {
        ...
        body: "One line is visible at start; sitting and waiting reveals nothing. Even a low-confidence wrong guess pushes dialogue forward and earns you an attribute row — there's no penalty for advancing.",
      },
      {
