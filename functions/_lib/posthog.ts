...
// (it's in every page load by design — OWdle and Deadlockle share one
// PostHog project, split by the site prop). Pages Functions can't read
  ...
  const send = fetch(POSTHOG_ENDPOINT, {
    ...
    body: JSON.stringify({
      ...
      properties: {
        ...
        // site=deadlockle-filtered dashboard.
        site: "deadlockle",
        $process_person_profile: false,
        $lib: "deadlockle-pages-fn",
      },
    }),
  }).catch(() => {
