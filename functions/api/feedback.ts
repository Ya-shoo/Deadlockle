...
// shared with OWdle on the canonical owdle-votes D1; the `source` column
// records which site the submission came from so we can filter per site
// when reading the feedback back via the CLI.
//
...
const PROJECT = "deadlockle";
const SITE_URL = "https://deadlockle.com";
// Deadlockle brand gold. Used as the embed accent in Discord so the
// notification reads as "this came from Deadlockle" at a glance even
// when the channel is shared with OWdle alerts.
const EMBED_COLOR = 0xd6a05c;
