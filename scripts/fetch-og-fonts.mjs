...
// from the edge flaked ~50% of the time (intermittent instant
// rejections), 503ing the card. Same-origin statics are as reliable as
// the spray assets and get edge-cached.
//
...
// NOTE: no "&" in SUBSET (it would need careful encoding and nothing
// renders it); "—" is the lost-mode count glyph on daily pills.
...
const FONTS = [
  { family: "Cinzel", weight: 800, out: "cinzel-800.ttf" },
  { family: "Source Sans 3", weight: 600, out: "source-sans-600.ttf" },
  { family: "Source Sans 3", weight: 500, out: "source-sans-500.ttf" },
  { family: "JetBrains Mono", weight: 500, out: "jetbrains-500.ttf" },
];
...
for (const f of FONTS) {
  ...
  // TTF magic: 00 01 00 00 (or 'OTTO' for CFF).
