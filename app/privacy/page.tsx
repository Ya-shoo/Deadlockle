...
const PAGE_DESCRIPTION =
  "How Deadlockle handles user data — the analytics, cookies, and advertising used, and the privacy rights available under GDPR and CCPA.";
  ...
  return (
    <main className="flex-1">
      <div className="mx-auto max-w-3xl px-6 py-14 text-[15px] leading-relaxed text-ink-soft [&_h2]:mt-10 [&_h2]:mb-2 [&_h2]:scroll-mt-24 [&_h2]:text-base [&_h2]:text-ink [&_h3]:mt-5 [&_h3]:mb-1 [&_h3]:text-ink [&_li]:[text-wrap:pretty] [&_li]:marker:text-ink-faint [&_p]:mt-3 [&_p]:[text-wrap:pretty] [&_ul]:mt-2 [&_ul]:list-disc [&_ul]:space-y-1.5 [&_ul]:pl-5">
        ...
        <p>
          Analytics may include session replay &mdash; anonymized recordings of
          on-page interactions, used to diagnose bugs and usability issues. When
          used, it captures only a sample of sessions, masks text entered into
          form fields, and never records payment information.
        </p>
        ...
        <ul>
          <li>
            Strictly necessary &mdash; keeping the site online and protecting it
            against abuse.
          </li>
          <li>
          ...
          <li>
            Advertising &mdash; Google AdSense and its partners, for delivering,
        ...
        <p>Deadlockle is supported by ads served through Google AdSense.</p>
        <p>
        ...
        <ul>
          ...
          <li>
            Understand how the game is used, and diagnose errors and performance
            issues.
          </li>
        ...
        <ul>
          ...
          <li>
            Consent &mdash; for non-essential cookies and for advertising and ad
            personalization. Consent can be withdrawn at any time.
          </li>
        </ul>
        ...
        <p>
          ...
          portability, and to withdraw consent. Users may also lodge a complaint
          with their local data protection authority.
        </p>
        <p>
          California (CCPA/CPRA): California users have the right to know what is
          collected, to delete it, to correct it, to opt out of its sale or
        ...
        <p>
          California residents (and users covered by a similar US state law) can
          opt out of the &ldquo;sale&rdquo; or &ldquo;sharing&rdquo; of their
          personal information for personalized advertising:
        </p>
        <ul>
          <li>
            Use the choices in the consent/privacy banner shown with the ads, or
          </li>
          <li>
            Enable a{" "}
        ...
        <p>
          ...
          long as it is useful. Data stored in the browser remains until the user
          clears it.
        </p>
        ...
        <p>
          ...
          updated&rdquo; date at the top will be revised, and significant changes
